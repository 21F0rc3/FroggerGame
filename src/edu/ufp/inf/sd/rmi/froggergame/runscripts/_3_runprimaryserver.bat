@REM ************************************************************************************
@REM Description: run PrimaryServer
@REM Author: Gabriel Fernandes
@REM Date: 13/05/2022
@REM ************************************************************************************
...
@REM java -cp %CLASSPATH% -Djava.rmi.server.codebase=%SERVER_CODEBASE% -Djava.rmi.server.hostname=%SERVER_RMI_HOST% -Djava.security.policy=%SERVER_SECURITY_POLICY% %JAVAPACKAGEROLE%.%SERVER_CLASS_PREFIX%%SERVER_CLASS_POSTFIX% %REGISTRY_HOST% %REGISTRY_PORT% %SERVICE_NAME_ON_REGISTRY%
java -cp %CLASSPATH% -Djava.rmi.server.codebase=%SERVER_CODEBASE% -Djava.rmi.server.hostname=%SERVER_RMI_HOST% -Djava.security.policy=%SERVER_SECURITY_POLICY% %JAVAPACKAGEROLE%.%PRIMARY_SERVER_CLASS_PREFIX%%SERVER_CLASS_POSTFIX% %REGISTRY_HOST% %REGISTRY_PORT% %PRIMARY_SERVER_SERVICE_NAME_ON_REGISTRY%
