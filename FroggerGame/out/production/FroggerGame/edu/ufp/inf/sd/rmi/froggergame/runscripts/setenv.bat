...
@Set WORKDRIVE=C
@Set JDK=%WORKDRIVE%:\\Users\\Gabri\\.jdks\\corretto-1.8.0_322
...
@set JAVAPROJ=%WORKDRIVE%:\\Users\\%USERNAME%\\IdeaProjects\\FroggerGame\\%JAVAPROJ_NAME%
...
@Set CLIENT_CLASS_PREFIX=Frogger
@Set SERVER_CLASS_PREFIX=Frogger
